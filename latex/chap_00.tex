...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{chapitre0/e-estonia_home.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{chapitre0/idemia_home.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{chapitre0/onfido_home.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{chapitre0/serpro_home.png}
...
Le tableau 1.3 illustre les différents besoins fonctionnels de l'acteur «citoyens brésiliens».
\begin{longtable}
